...
public final class CCEnchantments {
    ...
    public static final Enchantment O_NEGATIVE = register("o_negative", new ChestCavityEnchantment(Enchantment.Rarity.RARE, EnumEnchantmentType.ALL, EntityEquipmentSlot.values(), 50, 100, 2, true, false));
