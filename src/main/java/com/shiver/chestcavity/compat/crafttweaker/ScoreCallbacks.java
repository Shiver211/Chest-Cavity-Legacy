...
public final class ScoreCallbacks {
    ...
    @ZenClass(ChestCavityCtConstants.CT_NAMESPACE + "scores.OnScoreChanged")
    @ZenRegister
    public interface OnScoreChanged {
        void handle(IEntityLivingBase entity, String scoreId, float value, float previousValue);
    }

    @ZenClass(ChestCavityCtConstants.CT_NAMESPACE + "scores.OnServerTick")
    @ZenRegister
    public interface OnServerTick {
        void handle(IEntityLivingBase entity, String scoreId, float value, float baseValue);
    }

    @ZenClass(ChestCavityCtConstants.CT_NAMESPACE + "scores.OnClientTick")
    @ZenRegister
    public interface OnClientTick {
        void handle(IEntityLivingBase entity, String scoreId, float value, float baseValue);
    }

    @ZenClass(ChestCavityCtConstants.CT_NAMESPACE + "scores.OnBreakSpeed")
    @ZenRegister
    ...
    @ZenClass(ChestCavityCtConstants.CT_NAMESPACE + "scores.OnIncomingDamage")
    @ZenRegister
    ...
    @ZenClass(ChestCavityCtConstants.CT_NAMESPACE + "scores.OnAttackTarget")
    @ZenRegister
    ...
    @ZenClass(ChestCavityCtConstants.CT_NAMESPACE + "scores.OnJump")
    @ZenRegister
    public interface OnJump {
        void handle(IEntityLivingBase entity, String scoreId, float value, float baseValue);
    }

    @ZenClass(ChestCavityCtConstants.CT_NAMESPACE + "scores.OnEat")
    @ZenRegister
    public interface OnEat {
        void handle(IEntityLivingBase entity, IItemStack food, String scoreId, float value, float baseValue);
    }

    @ZenClass(ChestCavityCtConstants.CT_NAMESPACE + "scores.OnPotionIncoming")
    @ZenRegister
