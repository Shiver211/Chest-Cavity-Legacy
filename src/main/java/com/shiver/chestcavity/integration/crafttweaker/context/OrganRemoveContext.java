...
@ZenClass(CtConstants.CT_NAMESPACE + "OrganRemoveContext")
@ZenRegister
public class OrganRemoveContext {
    ...
    public OrganRemoveContext(EntityLivingBase entity, int slot, ItemStack stack, ScriptDataRuntime scriptData) {
        this.entity = entity;
        this.slot = slot;
        this.stack = stack;
